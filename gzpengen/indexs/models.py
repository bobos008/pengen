...
class CompanyInfo(models.Model):
    ...
    qrcode_img1 = models.ImageField(u'公司网页头部小的二维码', help_text="图片大小为76×76px", upload_to='imgs/home/')
    qrcode_img2 = models.ImageField(u'公司网页底部大的二维码', help_text="图片大小为122×122px", upload_to='imgs/home/')
    # qrcode_img3 = models.ImageField(u'公司网页中部的二维码', help_text="图片大小为237x237px", upload_to="imgs/home/")
    logo_img1 = models.ImageField(u'公司网页头部logo', help_text="图片大小为293×90px", upload_to='imgs/home/')
    logo_img2 = models.ImageField(u'公司网页底部logo', help_text="图片大小为114×145px", upload_to='imgs/home/')
...
class SeasonalFineProducts(models.Model):
    ...
    goods_image = models.ImageField(u'头图', help_text="图片大小为456×242px！", null=True, upload_to='imgs/home/')
    image1 = models.ImageField(u'详情图片1', help_text="图片大小为119×87px!", upload_to='imgs/home/')
    image2 = models.ImageField(u'详情图片2', help_text="图片大小为119×87px!", upload_to='imgs/home/')
    image3 = models.ImageField(u'详情图片3', help_text="图片大小为119×87px!", upload_to='imgs/home/')
...
class SuperAffordable(models.Model):
    ...
    not_contain_cost = models.TextField(u'费用不含', null=True, blank=True)
    self_funded_project = models.TextField(u'自费项目', null=True, blank=True)
    goods_image = models.ImageField(u'头图', help_text="图片大小为456×242px！", null=True, upload_to='imgs/home/', blank=True)
    image1 = models.ImageField(u'详情图片1', help_text="图片大小为119×87px!", upload_to='imgs/home/')
    image2 = models.ImageField(u'详情图片2', help_text="图片大小为119×87px!", upload_to='imgs/home/')
    image3 = models.ImageField(u'详情图片3', help_text="图片大小为119×87px!", upload_to='imgs/home/')
    trip_style = models.IntegerField(u'旅游类型', choices=TRIP_STYLE, default=0)
...
class TripKnowledge(models.Model):
    ...
    knowledge_image = models.ImageField(u'图片', help_text="图片大小为463×335px!", upload_to='imgs/home/')
