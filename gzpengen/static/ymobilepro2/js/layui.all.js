...
layui.define("layer", function(e) {
    ...
    p.prototype.initIE = function() {
        ...
        t.elem.next().hasClass(f) || (e.elemFile.wrap(a),
          ...
          , d = {
            select: function() {
                var e, t = "请选择", a = "layui-form-select", n = "layui-select-title", r = "layui-select-none", d = "", f = u.find("select"), v = function(t, l) {
                    ...
                    var h, p = i(this), m = t.find("." + n), k = m.find("input"), g = t.find("dl"), x = g.children("dd"), b = this.selectedIndex;
                    if (!u) {
                        var C = function() {
                        ...
                        x.on("click", function() {
                            var e = i(this)
                              , a = e.attr("lay-value")
                              , n = p.attr("lay-filter");
                            return !e.hasClass(o) && (e.hasClass("layui-select-tips") ? k.val("") : (k.val(e.text()),
                            e.addClass(s)),
